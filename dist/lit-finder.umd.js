(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["lit-finder"] = factory();
	else
		root["lit-finder"] = factory();
...
// Module
exports.push([module.i, ".finder-container{display:flex;overflow-x:auto}.finder-container .finder-column{border-right:1px dotted #c2c2c2}.finder-container .finder-column .finder-cell-item{padding:10px 20px;border-bottom:1px dotted #c2c2c2;cursor:pointer;display:flex;font-weight:400;align-items:stretch;min-height:41px}.finder-container .finder-column .finder-cell-item .arrow{display:inline-block;border-right:3px solid #000;border-bottom:3px solid #000;width:6px;height:6px;transform:rotate(-45deg)}.finder-container .finder-column .finder-cell-item span.finder-highlight{padding:5px 0;color:#dc143c}.finder-container .finder-column .finder-cell-item div{flex:1;padding-left:10px}.finder-container .finder-column .finder-cell-item span{align-self:center}.finder-container .finder-column .finder-cell-item.active{background:#1a79d0;color:#fff}.finder-container .finder-column .finder-cell-item.active .arrow{border-right:3px solid #fff;border-bottom:3px solid #fff}.finder-container .finder-column-hidden{display:none}.finder-wrapper{display:flex;border:1px dotted #c2c2c2;position:relative}.finder-wrapper .finder-root{flex:1}.finder-wrapper .finder-detail-wrapper{width:50%;transition:.1s;border-left:1px dotted #c2c2c2}#finder-loader{position:absolute;width:100%;height:100%;cursor:pointer;display:none;z-index:2;top:0;left:0;background:hsla(0,0%,94.5%,.5)}.loader{border:3px solid #fff;border-top:3px solid #000;position:absolute;top:calc(50% - 15px);left:calc(50% - 15px);border-radius:50%;width:30px;height:30px;-webkit-animation:spin 2s linear infinite;animation:spin 2s linear infinite}@-webkit-keyframes spin{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}@keyframes spin{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}", ""]);
// Exports
...
// load the styles
var content = __webpack_require__("e4f5");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("7535c61e", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Finder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("ebf8");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Finder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Finder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Finder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./src/Finder.vue?vue&type=template&id=22227b72&
...
// CONCATENATED MODULE: ./src/assets/finder.js
...
/* harmony default export */ var finder = ((function () {
  ...
  var init = function init(element) {
    ...
    options = _objectSpread2(_objectSpread2({}, baseConfig), initOptions);
  };
  ...
  function __recursiveTree(data) {
    var isVisible = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    var recursiveAll = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var index = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
    var uuid = uuidv4();

    var column = __createColumn(uuid, isVisible); // finderTreeItem[index] = data;
    ...
    if (recursiveAll && data[0].hasOwnProperty('children') && data[0].children.length) {
  ...
  function __createCell(data, index) {
    var children = data.children,
        ...
        type = data.type,
        suffix = data.suffix,
        _data$suffixClass = data.suffixClass,
        suffixClass = _data$suffixClass === void 0 ? '' : _data$suffixClass;
    var label = data.label || '';
    var node = document.createElement('div');
    node.classList.add('finder-cell-item');

    if (options.highlightFile && type === 'file' || options.highlightFolder && type === 'folder') {
      if (options.keyword) {// const regex = new RegExp(options.keyword, "ig");
    ...
    node.addEventListener('click', function () {
      ...
      var targetIndex = columns.indexOf(node.parentNode);
      /** add children */
      ...
      if (options.hasOwnProperty('handleItemClick')) {
        if (syncData) {
          ...
          options.handleItemClick(data, targetIndex).then(function (data) {
            /** remove right column from target column */
            columns.forEach(function (element, elementIndex) {
          ...
          if (data.options || type === 'file') {
            options.handleItemClick(data, targetIndex).finally(function () {
              node.style.pointerEvents = 'auto';
            });
          }
...
/* harmony default export */ var Findervue_type_script_lang_js_ = ({
  name: 'Finder',
  props: {
    tree: {
      type: Array,
  ...
  mounted: function mounted() {
    ...
    var container = document.querySelector('.finder-root');

    var initOptions = _objectSpread2({}, this.options);

    if (this.handleItemClick) {
      initOptions.handleItemClick = function (node, columnIndex) {
        _this.showDetail = node.type === 'file';
        ...
        if (_this.showDetail) {
          ...
          _this.currentFileData = node;
        }

        return _this.handleItemClick(node, {
  ...
  methods: {
    reRender: function reRender(data, options) {
...
// CONCATENATED MODULE: ./src/Finder.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_Findervue_type_script_lang_js_ = (Findervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/Finder.vue?vue&type=style&index=0&lang=scss&
var Findervue_type_style_index_0_lang_scss_ = __webpack_require__("f23f");
...
// CONCATENATED MODULE: ./src/Finder.vue
...
var component = normalizeComponent(
  src_Findervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Finder = (component.exports);
// CONCATENATED MODULE: ./src/index.js

/* harmony default export */ var src_0 = (Finder);
...
//# sourceMappingURL=lit-finder.umd.js.map